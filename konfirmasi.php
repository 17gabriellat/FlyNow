<?php 
$page_title = 'Ticket Details - FLYNOW';
...
<main class="flex-1 p-10">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold">Ticket Details (ID: <?php echo $transaction_id; ?>)</h1>
        <a href="pesanan_saya.php" class="bg-gradient-to-t from-gray-600 to-gray-400 text-white px-4 py-2 rounded-md hover:bg-gradient-to-r from-gray-600 to-gray-400">
            &larr; Back
        </a>
    </div>
